function Card({ username, age="N/A" }) {
    return (
        <div className="bg-neutral-primary-soft block max-w-sm p-6 m-6 border border-default rounded-xl shadow-xs">
            ...
            <a href="https://google.com" className="inline-flex items-center text-white bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">
                {username} + {age}
